...
public class Lab4{
    ...
    static void transaction(double d, double w){
        if(d!=0.0)
            System.out.println("The last transaction was deposition of amount "+d);
        else if(w!=0.0)
            System.out.println("The last transaction was withdrawal of amount "+w);
        else
            System.out.println("Transaction details not available!!");
    }

    static void summary(double n_bal){
        System.out.println("Your current account balance is: "+n_bal);
    }
